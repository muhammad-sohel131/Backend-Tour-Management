...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const data = {
        ...
        success_url: `${env_1.envVars.SSL.SSL_SUCCESS_BACKEND_URL}?transactionId=${payload.transaction}&amount=${payload.amount}&status=success`,
        fail_url: `${env_1.envVars.SSL.SSL_FAIL_BACKEND_URL}?transactionId=${payload.transaction}&amount=${payload.amount}&status=fail`,
        cancel_url: `${env_1.envVars.SSL.SSL_CANCEL_BACKEND_URL}?transactionId=${payload.transaction}&amount=${payload.amount}&status=cancel`,
        shipping_method: "N/A",
        product_name: "Tour",
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGatewaysData: response.data }, { runValidators: true });
    }
    catch (err) {
        console.log(err);
        throw new AppError_1.default(401, `Payment Validation Error, ${err.message}`);
    }
});
exports.sslService = {
    sslPaymentInit,
